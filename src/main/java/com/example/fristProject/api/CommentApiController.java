...
public class CommentApiController {
    ...
    public ResponseEntity<CommentDto> create(@PathVariable Long articleId, @RequestBody CommentDto comment) {
        CommentDto createdDto = commentService.create(articleId, comment);
